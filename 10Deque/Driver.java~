...
//-Randomly adds to the beginning or end, instead of a set amount of adding to beginning or end
//-Fixed the loop to remove elements. The previous version didn't function properly because the loop occurred
//limit times and two elements were being removed at a time
